...
//        qInfo() << "Serial::SerialImpl::SerialImpl open " << QString::fromStdString(port);
//        open ();
//    }
...
void Serial::SerialImpl::scan()
{
    qInfo() << "Scanning...";
    HANDLE fd_ = INVALID_HANDLE_VALUE;
    wstring port_{};

//    QString mListCom = "COM1";
    QList<string> mList;
    mList.append("COM1");
    mList.append("COM2");
    mList.append("COM3");
    ...
    mList.append("COM9");
    mList.append("COM10");
//    port_ = mList.at(0).toStdWString();

    foreach (string strCom, mList) {
        port_ = wstring(strCom.begin(), strCom.end());
        ...
        if (fd_ == INVALID_HANDLE_VALUE) {
            qInfo() << QString::fromStdString(strCom) << " is not connected.";
...
Serial::SerialImpl::read (uint8_t *buf, size_t size)
{
    ...
    qInfo() << "Serial::SerialImpl::read " << bytes_read;
